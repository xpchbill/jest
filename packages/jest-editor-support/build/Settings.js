...
require('child_process');const ChildProcess = _require.ChildProcess; /**
                                                                      ...
                                                                      *
                                                                      * 
                                                                      */const EventEmitter = require('events');const ProjectWorkspace = require('./ProjectWorkspace');var _require2 = require('./Process');const createProcess = _require2.createProcess; // This class represents the the configuration of Jest's process
