...
require('child_process');const ChildProcess = _require.ChildProcess,spawn = _require.spawn; /**
                                                                                             ...
                                                                                             *
                                                                                             * 
                                                                                             */var _require2 = require('fs');const readFile = _require2.readFile;var _require3 = require('os');const tmpdir = _require3.tmpdir;var _require4 = require('events');const EventEmitter = _require4.EventEmitter;const ProjectWorkspace = require('./ProjectWorkspace');var _require5 = require('./Process');const createProcess = _require5.createProcess; // This class represents the running process, and
